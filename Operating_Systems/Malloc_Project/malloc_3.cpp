...
void init(){
    ...
    mbl.BlockBank[MAX_ORDER] = (MallocMetadata*)sbrk(32*DEF_SIZE);
...
void* scalloc(size_t num, size_t size){
    ...
    if(total_size > DEF_SIZE-met_size){
